...
| --- | --- |
| [![My Languages](https://skillicons.dev/icons?i=js,html,css,ts,nodejs,lua,java,python)](https://skillicons.dev) | [![My Platforms](https://skillicons.dev/icons?i=raspberrypi,windows,arch,linux)](https://skillicons.dev) |
...
> [!NOTE]
> The statistics above only reflect my public repositories - they do not reflect my skills or complete activity on GitHub.
